...
statement
    ...
    | CREATE ((SOURCE | INPUT) | (SINK | OUTPUT) ) TABLE (IF NOT EXISTS)? qualifiedName
...
queryStream
    : WITH identifier AS '(' queryStr ')' (WATERMARK watermark)?    #withQueryStream
    | queryStr                                                      #simpleQueryStream
    ;
